...
export class TribufuGeneratedApi extends runtime.BaseAPI {
     ...
     */
    async generateFlakeIdRaw(requestParameters: GenerateFlakeIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
        const queryParameters: any = {};
     ...
     * Generate one or more flake ids.
     */
    async generateFlakeId(amount?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<number>> {
     ...
     */
    async generateFlakeIdFromTimestampRaw(requestParameters: GenerateFlakeIdFromTimestampRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<number>>> {
     ...
     * Generate one or more flake ids from a timestamp.
     */
    async generateFlakeIdFromTimestamp(timestamp: number, amount?: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<number>> {
     ...
     */
    async getUserAccountsRaw(requestParameters: GetUserAccountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ExternalAccount>>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(ExternalAccountFromJSON));
    }
     ...
     * Get a list of connected accounts of the user.
     */
    async getUserAccounts(id: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ExternalAccount>> {
